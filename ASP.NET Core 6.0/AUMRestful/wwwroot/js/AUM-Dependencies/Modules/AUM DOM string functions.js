...
export class AUMDOMStringFunctions {
     ...
     * @param {object} objectKey The key for the object.
     * @param {string} decorator The decorator character(s) to append between strings.
     ****/
     ...
     * @param {array} keys The keys array for strings in this.Strings to decorate.
     * @param {string} decorator The decorator character(s) to append between strings.
     ****/
     ...
     * @param {string} stringKey The string key to search for.
     * @param {string} decorator The decorator to character(s) append to the string.
     ****/
